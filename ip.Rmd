...
```{r}
a <- data.frame(Daily_internet_use = 150)
result <-  predict(advertising,a)
...
intrain <- createDataPartition(y=Clicked_ad, p= 0.8, list = FALSE)
training <-advertising$Clicked_ad[intrain,]
testing <- advertising$Clicked_ad[-intrain,]
